...
let clickCount = localStorage.getItem("clickCount"); // We are getting the value from localstorge

if (clickCount === null) {
    counterElement.textContent = 0; //If localStorage doesnot have a value in it, we are displaying 0
} else {
